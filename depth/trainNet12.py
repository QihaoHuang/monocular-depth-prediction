...
from param_utils import BATCH_SIZE, LR, EPOCHS, USE_GPU, NUM_WORKERS, MOMENTUM, GAMMA, STEP_SIZE, DELTA, net12_H, \
    net12_W
...
def train_model(model, criterion, optimizer, scheduler, num_epochs, delta):
    ...
    writer = SummaryWriter('runsNet12')
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for i, data in enumerate(data_loaders[phase]):
                ...
                # writer.add_image('output image', x, i)
                # # print(outputs.shape)
                #
                #
                # print(outputs.max())
            ...
            epoch_acc = running_corrects / (dataset_sizes[phase] * net12_H * net12_W)
